...
public class DDialogVee : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("Hello, I wanted to test this system so here goes.", "Mage"));

        dialogTexts.Add(new DialogData("This is another character ", "Sa"));
